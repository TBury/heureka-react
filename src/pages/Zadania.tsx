...
const Fitness = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8080/api/fitnessFunction/')
      .then((res) => {
  ...
  const handleDeleteClick = (id) =>
    axios.delete(`http://localhost:8080/api/session/${id}`)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
  ...
  const resumeSession = (id, algorithms, FitnessFunctions) => {
    axios.post(`http://localhost:8080/api/task/${id}?resume=true`)
      .then((res) => {
  ...
  const getPDFDownloadLink = (id) => {
    axios.get(`http://localhost:8080/api/session/${id}/pdf`)
      .then((res) => {
