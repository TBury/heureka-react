...
const Fitness = ({ functions, formFields, handleFormChange, addFields, domain, removeFields, handleDeleteClick, handleEditClick, handleAddClick, error, showDeleteModal, setShowDeleteModal, showEditModal, setShowEditModal, showAddModal, setShowAddModal }) => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <Button color="blue" className="mb-8" onClick={() => setShowAddModal(true)}>+ Dodaj nową funkcję</Button>
          ...
          <tbody>
            {functions.map((fun) => {
              return <tr key={fun.id} >
                ...
                {(fun.removeable === true || fun.removeable == 1)  ?
