...
const Fitness = ({ firstAlgorithm, firstFunction, algorithms, functions, handleDeleteClick, handleTestAlgorithmClick, handleTestFunctionClick, algorithmTestRunning, fitnessTestRunning, progress, results, sessions, resumeSession, setPDFDownloadLink }) => {
